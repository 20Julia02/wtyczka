...
class Ui_PyQGISDialogBase(object):
    def setupUi(self, PyQGISDialogBase):
        ...
        self.label_test = QtWidgets.QLabel(self.tab_height_area)
        self.label_test.setGeometry(QtCore.QRect(330, 50, 121, 61))
    ...
    def retranslateUi(self, PyQGISDialogBase):
        ...
        self.label_test.setText(_translate("PyQGISDialogBase", "TextLabel"))
